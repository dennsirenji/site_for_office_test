...
<CardGrid>
  <LinkCard title="Major infrastructure projects" href="/dist/guides/getting-started" />
  <LinkCard title="Innovative architectural accomplishments" href="/dist/guides/getting-started" />
  <LinkCard title="High-stress industrial applications" href="/dist/guides/getting-started" />
</CardGrid>
